...
local line_sep = wibox.widget.textbox(" | ")
local sound_sep = wibox.widget.textbox("  VOL: ")
local br_sep = wibox.widget.textbox("BR: ")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "r", function () awful.spawn("rofi -show drun -show-icons") end,
              {description = "open the run-prompt", group = "launcher"}),
    awful.key({ modkey,           }, "f", function () awful.spawn(files) end,
              {description = "open file manager", group = "launcher"}),
    awful.key({ modkey,           }, "c", function () awful.spawn(geditor) end,
              {description = "open a terminal", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "s", function () awful.spawn("flameshot gui") end,
              {description = "open a terminal", group = "launcher"}),
	awful.key({ modkey, "Shift"   }, "c", function () awful.spawn(network) end,
              {description = "open a terminal", group = "launcher"}),
    ...
    awful.key({ modkey, "Shift"   }, "l", function () awful.util.spawn("systemctl suspend") end),
